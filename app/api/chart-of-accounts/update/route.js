...
/**
 * PUT /api/chart-of-accounts/update
 * Update a chart of accounts item using v2/items/chart_of_accounts endpoint
 */
export async function PUT(request) {
  try {
    ...
    // Prepare data object with all fields (including guid)
    const requestData = {
      guid: data.guid,
    ...
    return NextResponse.json(
      {
        status: 'ERROR',
        description: error.message || 'Failed to update chart of accounts item',
